...
class unit:
    def __init__(self,root):
        ...
        txtUnitID=Entry(innerframe,font=fonts,textvariable=unitid,width=30)
        ...
        txtUnitName = Entry(innerframe, font=fonts, textvariable=unitname, width=30)
        ...
        self.member_record = ttk.Treeview(detailframe, heigh=12,
